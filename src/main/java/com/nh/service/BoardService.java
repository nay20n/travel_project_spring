...
public interface BoardService {
	 ...
	 * @param map1(bno, memberId, arrPlaceId, page)
	...
	/**
	 * 장소 검색 조회
	 * @param map1(memberId, bno, arrPlaceId, input, page)
	 * @return 검색한 장소 map 리스트(placeId, name, category, address, lat, lng, images, avgRating, reviewCnt, isLiked)
	 */
...
//	 * @return 해당 글의 정보 map 리스트(사진 때문에)(writerId, title, startPlaceId,  arrPlaceId, startDate, endDate, maxCost, transportCost, foodCost, roomCost, etcCost, reviewCnt, isLiked, likedCnt, blockIdx, startTime, endTime, colorIdx, colorCode, name)
//	 */
