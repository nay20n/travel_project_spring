...
public interface BoardService {
	 ...
	 * @param endDate
	 */
	int insertBoard(int writerId, String startPlaceId, String arrPlaceId, String startDate, String endDate);
	 ...
	 * @param bno
	 * @return 해당 글의 정보 map (bno, writerId, title, startPlaceId, arrPlaceId, startDate, endDate, arrPlaceCity, maxCost, transportCost, foodCost, roomCost, etcCost, reviewCnt, isLiked, likedCnt, arrMapData(lat, lng), blocks리스트(blockIdx, startTime, endTime, colorIdx, colorCode, name))
	 */
