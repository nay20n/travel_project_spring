...
public interface PlaceDao {
	 ...
	 * @param placeId
	 * @param memberId
	 * @return 장소정보 name, avgRating, category, reviewCnt, address, businessHours, websiteUrl, isLiked, images 리스트, rating0~5
	 */
	 ...
	 */
	void addPlace(String placeId, String name, String category, String address, Number lat, Number lng, String websiteUrl, String businessHours);
