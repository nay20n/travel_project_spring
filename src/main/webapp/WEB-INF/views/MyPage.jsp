...
<div id="profile" class="bs"> <!--젤 위 프로필 박스-->
	...
	<div class="bs"> <!--찜 수 박스-->
		...
		<div>찜한 수</div>
		<div>${getMyPage.getMemberProfile.cntLike}</div>
	</div>
	<div class="bs"> <!--댓글 쓴 수 박스-->
		...
		<div>댓글 쓴 수</div>
		<div>${getMyPage.getMemberProfile.cntComment}</div>
	</div>
	<div class="bs"> <!--정보 수정-->
		<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
...
<div class="tableDiv bs"> <!--내 게시글 박스-->
	...
	<div class="table">
		<table class="bs">
			...
			<tbody>
				<c:forEach var="myBoard" items="${getMyPage.getMyBoard}" varStatus="status">
...
<div class="tableDiv bs">
	...
	<div class="table">
		<table class="bs">
			...
			<tbody>
				<c:forEach var="likeBoard" items="${getMyPage.getLikedBoard}" varStatus="status">
...
<div class="tableDiv bs">
	...
	<div class="table">
		<table class="bs">
			...
			<tbody>
				<c:forEach var="commentBoard" items="${getMyPage.getCommentBoard}" varStatus="status">
