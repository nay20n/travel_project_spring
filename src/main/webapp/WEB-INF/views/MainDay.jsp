...
<body>
	...
	<div id="main">
			...
			<div class="place">
				...
				<div class="placeInfo">
					<div class="placeTitle">
						<div>
							<a>로우앤스윗 로스터리 (Raw&Sweet Roastery Cafe)</a><span>카페</span>
						</div>
						<div>
							<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
		...
		<div>
			...
			<div id="dailyMap">
				<div class="calendar">
					<div>
						...
						<span class="moveDate">🌤️13일(월)</span>
						<span class="moveDate">></span> 
					</div>
					<img src="img/daily.png"/>
				</div>
				<div id="aiCalendar" class="hide">
					<div>
						<span class="bs">AI추천 일정</span>
						<svg class="fr" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
			...
			<button class="bs">AI 추천 일정</button>
		</div>
	</div>
			...
			<div>
				...
				<div class="popupPlace">
					...
					<div class="placeDetail">
						...
						<div>
							<div>월요일: 오전 9:00 ~ 오후 8:00</div>
							<div>화요일: 오전 9:00 ~ 오후 8:00</div>
							<div>수요일: 오전 9:00 ~ 오후 8:00</div>
							<div>목요일: 오전 9:00 ~ 오후 8:00</div>
							<div>금요일: 오전 9:00 ~ 오후 8:00</div>
							<div>토요일: 오전 9:00 ~ 오후 8:00</div>
							<div>일요일: 오전 9:00 ~ 오후 8:00</div>
						</div>
						<div>
							<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
